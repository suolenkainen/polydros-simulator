...
response = requests.post(
    ...
    json={'seed': 42, 'agents': [{'name': 'Agent 1'}, {'name': 'Agent 2'}], 'ticks': 2},
    timeout=10
)
        ...
        if result['agents']:
            ...
            if 'card_instances' in agent:
                ...
                if agent['card_instances']:
                    ...
                    flavor = instance.get('flavor_text', 'N/A')[:50]
                    print(f"Card flavor text: {flavor}...")
                    ...
                    if 'price_history' in instance:
                        ...
                        for point in history[:3]:
                            ...
                            print(f"  Tick {tick}: Price {price} Prisms")
else:
